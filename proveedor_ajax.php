			...
			while($row = mysqli_fetch_array($query)){
				...
				<tr>
					...
					<td>
						...
						<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#dataDelete" data-id="<?php echo $row['ID_PROVEEDOR']?>"  ><i class='nav-icon fa fa-trash' ></i></button>
					</td>
				</tr>
				<?php
            }
